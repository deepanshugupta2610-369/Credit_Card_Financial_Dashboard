...
Credit card financial dashboard using Power BI & SQ
To develop an interactive dashboard using transaction and customer data from a SQL database, to provide real-time insights.
